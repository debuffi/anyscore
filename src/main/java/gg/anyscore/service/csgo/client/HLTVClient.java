package gg.anyscore.service.csgo.client;
...
public interface HLTVClient {
    ...
    ResponseEntity<String> getPlayerAsHtml(@PathVariable Long playerId, @PathVariable String playerName, @RequestHeader("User-Agent") String userAgent);
}
